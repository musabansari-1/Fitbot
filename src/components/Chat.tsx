...
export default function Chat() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] max-w-4xl mx-auto bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
      {/* Header with safe area padding */}
      <div 
        className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-4 shadow-lg sticky top-0 z-10"
      ...
      <div 
        className="flex-1 overflow-y-auto p-4 space-y-1 w-full"
        style={{
          paddingTop: '0.5rem',
      ...
      >
        ...
        {chatState.isTyping && <TypingIndicator />}
        <div ref={messagesEndRef} className="pb-[env(safe-area-inset-bottom)]" />
      </div>

      {/* Input with safe area padding */}
      <div 
        className="sticky bottom-0 w-full bg-gradient-to-b from-slate-50 to-blue-50 pt-2"
